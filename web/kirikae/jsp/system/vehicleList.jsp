...
<head>
    ...
    <%@include file="../../../jsp/public/js.jsp"%>
    <%@include file="../../../jsp/public/css.jsp"%>
</head>
...
<div id="vehicleAddModal" class="modal fade" tabindex="-1"
    ...
    <form id="vehicleAddModalForm" method="post" class="form-inline" action="<%=request.getContextPath()%>/vehicle/addVehicle.do">
...
<script src="<%=request.getContextPath()%>/js/module/system/vehicleList.js?version=1"></script>
</html>
