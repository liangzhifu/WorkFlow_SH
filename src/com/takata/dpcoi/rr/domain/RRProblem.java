package com.takata.dpcoi.rr.domain;
...
public class RRProblem {
    ...
    private Integer standardBookFileId;
    ...
    public Integer getPfmeaFileId() {
        return pfmeaFileId;
    }

    public void setPfmeaFileId(Integer pfmeaFileId) {
        this.pfmeaFileId = pfmeaFileId;
    }

    public Integer getCpFileId() {
        return cpFileId;
    }

    public void setCpFileId(Integer cpFileId) {
        this.cpFileId = cpFileId;
    }

    public Integer getStandardBookFileId() {
        return standardBookFileId;
    }
