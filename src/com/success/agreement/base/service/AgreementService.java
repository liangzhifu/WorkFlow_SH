...
public interface AgreementService {
	...
	// 发送审核
	Integer updateAuditingAgreement(Integer agreementId) throws Exception;

	// 审核通过
	Integer updateAcceptAgreement(Integer agreementId) throws Exception;

	// 审核拒绝
	Integer updateRefuseAgreement(Integer agreementId, String refuseText) throws Exception;
}
