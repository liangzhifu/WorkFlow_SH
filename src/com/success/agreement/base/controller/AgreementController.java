...
public class AgreementController {
	...
	public String getAgreementAddNewDlg(HttpServletRequest request,
		...
		try {
			...
			model.put("userId", principal.getId());
	...
	public void addAgreement(HttpServletRequest request,HttpServletResponse response, Map<String, Object> model){
		...
		try{
			...
			Principal principal = PrincipalUtils.getPrincipal();
			this.historyService.addCopyAgreement(agreementId, principal.getId(), "新增");
			map.put("success", true);
		}catch(Exception e){
			e.printStackTrace();
			map.put("success", false);
	...
	// 发送审核
	@RequestMapping("/auditingAgreement.do")
	public void auditingAgreement(HttpServletRequest request,HttpServletResponse response, Map<String, Object> model){
		Map<String, Object> map = new HashMap<String, Object>();
		try{
			Integer agreementId =  ServletAPIUtil.getIntegerParameter("agreementId", request);
			this.agreementService.updateAuditingAgreement(agreementId);
			map.put("success", true);
		}catch(Exception e){
			e.printStackTrace();
			map.put("success", false);
	...
	// 审核拒绝
	@RequestMapping("/refuseAgreement.do")
	public void refuseAgreement(HttpServletRequest request,HttpServletResponse response, Map<String, Object> model){
		Map<String, Object> map = new HashMap<String, Object>();
		try{
			Integer agreementId =  ServletAPIUtil.getIntegerParameter("agreementId", request);
			String refuseText = ServletAPIUtil.getStringParameter("refuseText", request);
			this.agreementService.updateRefuseAgreement(agreementId, refuseText);
			map.put("success", true);
		}catch(Exception e){
			e.printStackTrace();
			map.put("success", false);
	...
	// 审核通过
	@RequestMapping("/acceptAgreement.do")
	public void acceptAgreement(HttpServletRequest request,HttpServletResponse response, Map<String, Object> model){
		Map<String, Object> map = new HashMap<String, Object>();
		try{
			Integer agreementId =  ServletAPIUtil.getIntegerParameter("agreementId", request);
			this.agreementService.updateAcceptAgreement(agreementId);
			map.put("success", true);
		}catch(Exception e){
			e.printStackTrace();
			map.put("success", false);
