...
public class TaskTacheSysInfo {

    private Integer taskTacheInfoId;

    private Integer syserInfoId;
    ...
    public Integer getSyserInfoId() {
        return syserInfoId;
    }

    public void setSyserInfoId(Integer syserInfoId) {
        this.syserInfoId = syserInfoId;
    }
}
