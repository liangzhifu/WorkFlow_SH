 ...
 * @create 2017-07-20
 **/
@Repository("rRDelayStatistics2Dao")
public class RRDelayStatistics2Dao extends BaseDao{
    ...
    public Integer insertRRDelayStatistics(RRDelayStatistics rrDelayStatistics){
        return this.sqlSession.insert("RRDelayStatisticsMapper2.insertSelective", rrDelayStatistics);
    }
    ...
    public List<Map<String, Object>> selectStatisticsList(RRDelayStatisticsQuery rrDelayStatisticsQuery){
        return this.sqlSession.selectList("RRDelayStatisticsMapper2.selectStatisticsList", rrDelayStatisticsQuery);
    }
    ...
    public List<Map<String, Object>> selectRRDelayStatisticsList(RRDelayStatisticsQuery rrDelayStatisticsQuery){
        return this.sqlSession.selectList("RRDelayStatisticsMapper2.selectRRDelayStatisticsList", rrDelayStatisticsQuery);
    }
    ...
    public Integer selectStatisticsCount(RRDelayStatisticsQuery rrDelayStatisticsQuery){
        return this.sqlSession.selectOne("RRDelayStatisticsMapper2.selectStatisticsCount", rrDelayStatisticsQuery);
    }
