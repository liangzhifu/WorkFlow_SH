...
//@Component("updateRRProblemSpeedOfProgress2")
public class UpdateRRProblemSpeedOfProgress2 {
    ...
    @Resource(name = "rRDelayLeader2Service")
    private RRDelayLeader2Service rRDelayLeaderService;
