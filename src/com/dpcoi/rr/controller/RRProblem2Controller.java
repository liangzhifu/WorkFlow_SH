...
import com.dpcoi.drived.service.ExportExcel2Service;
 ...
 **/
@Controller
@RequestMapping("/rrProblem2")
public class RRProblem2Controller {
    ...
    @Resource(name = "exportExcel2Service")
    private ExportExcel2Service exportExcelService;
