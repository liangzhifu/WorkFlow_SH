 ...
 **/
@Controller
@RequestMapping("/dpcoiConfigVehicle2")
public class DpcoiConfigVehicle2Controller {

    @Resource(name = "dpcoiConfigVehicle2Service")
    private DpcoiConfigVehicle2Service dpcoiConfigVehicleService;
