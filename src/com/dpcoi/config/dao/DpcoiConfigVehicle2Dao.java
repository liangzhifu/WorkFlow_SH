 ...
 **/
@Repository
public class DpcoiConfigVehicle2Dao extends BaseDao{
    ...
    public Integer insertDpcoiConfigVehicle(DpcoiConfigVehicle dpcoiConfigVehicle){
        return this.sqlSession.insert("dpcoiConfigVehicleMapper2.insertSelective", dpcoiConfigVehicle);
    }
    ...
    public Integer updateDpcoiConfigVehicle(DpcoiConfigVehicle dpcoiConfigVehicle){
        return this.sqlSession.update("dpcoiConfigVehicleMapper2.updateByPrimaryKeySelective", dpcoiConfigVehicle);
    }
    ...
    public Integer selectDpcoiConfigVehicleCount(DpcoiConfigVehicleQuery dpcoiConfigVehicleQuery){
        return this.sqlSession.selectOne("dpcoiConfigVehicleMapper2.selectDpcoiConfigVehicleCount", dpcoiConfigVehicleQuery);
    }
    ...
    public List<Map<String, Object>> selectDpcoiConfigVehicleListPage(DpcoiConfigVehicleQuery dpcoiConfigVehicleQuery){
        return this.sqlSession.selectList("dpcoiConfigVehicleMapper2.selectDpcoiConfigVehicleListPage", dpcoiConfigVehicleQuery);
    }
    ...
    public List<Map<String, Object>> selectDpcoiConfigVehicleList(DpcoiConfigVehicleQuery dpcoiConfigVehicleQuery){
        return this.sqlSession.selectList("dpcoiConfigVehicleMapper2.selectDpcoiConfigVehicleList", dpcoiConfigVehicleQuery);
    }
    ...
    public List<Map<String, Object>> selectDpcoiConfigVehicle(DpcoiConfigVehicleQuery dpcoiConfigVehicleQuery){
        return this.sqlSession.selectList("dpcoiConfigVehicleMapper2.selectDpcoiConfigVehicle", dpcoiConfigVehicleQuery);
    }
}
