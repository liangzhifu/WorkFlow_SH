 ...
 */
@Repository
public class FileUpload2Dao extends BaseDao {
    /**
     * 插入一个FileUpload文件
    ...
    public Integer insertFileUpload(FileUpload fileUpload){
        return this.sqlSession.insert("fileUpload2.insertSelective", fileUpload);
    }
    ...
    public FileUpload selectBySelf(FileUpload fileUpload){
        return this.sqlSession.selectOne("fileUpload2.selectBySelf", fileUpload);
    }
